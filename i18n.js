(function () {
  ...
  var EXACT = {
    ...
    'reply':'Responder', 'send':'Enviar', 'read':'Leer', 'new':'Nuevo',
    ...
    'use book call from the main menu if you\'d like to talk.':'Usa RESERVAR LLAMADA en el menú principal si quieres conversar.',
  ...
  var PHRASES = [
    ...
    ['opens link', 'abre el enlace'], ['right soft key', 'tecla derecha'],
